...
# OBJETIVO
Realizar una navegación mostrando un listado de departamentos
 y despues con cada uno de ellos crear un enlace para que se pueda navegar
 al detalle de cada departamento.
...
Se introduce en el navegador la url http://localhost:8084/miApp/departamentos
...
-	/departamentos identifica el controlador que se va a encangar de la peticion: DepartamentosController
...
En  este proyecto "departamentos.html" es una plantilla y muestra el listado de departamentos
